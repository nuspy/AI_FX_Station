...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.acc_name.setPlaceholderText("default")
        self.acc_currency = QLineEdit()
        self.acc_currency.setPlaceholderText("USD")
        self.acc_balance = QLineEdit()
        self.acc_balance.setPlaceholderText("100000")
        self.acc_leverage = QLineEdit()
        self.acc_leverage.setPlaceholderText("30")
        self.acc_tiingo = QLineEdit()
        self.acc_tiingo.setPlaceholderText("Account Tiingo API key (optional)")

        self.ib_host = QLineEdit()
        self.ib_host.setPlaceholderText("127.0.0.1")
        self.ib_port = QLineEdit()
        self.ib_port.setPlaceholderText("7497")
        self.ib_client = QLineEdit()
        self.ib_client.setPlaceholderText("1")
        self.ib_user = QLineEdit()
        self.ib_user.setPlaceholderText("username")
        self.ib_pass = QLineEdit()
        self.ib_pass.setEchoMode(QLineEdit.Password)
        self.ib_pass.setPlaceholderText("password")

        self.mt_server = QLineEdit()
        self.mt_server.setPlaceholderText("broker server")
        self.mt_login = QLineEdit()
        self.mt_login.setPlaceholderText("login")
        self.mt_pass = QLineEdit()
        self.mt_pass.setEchoMode(QLineEdit.Password)
        self.mt_pass.setPlaceholderText("password")
        ...
        self.ctrader_access_token.setEchoMode(QLineEdit.Password)
        self.ctrader_access_token.setPlaceholderText("Access Token (optional - use if already have one)")
        self.ctrader_refresh_token = QLineEdit()
        self.ctrader_refresh_token.setEchoMode(QLineEdit.Password)
        self.ctrader_refresh_token.setPlaceholderText("Refresh Token (optional - for auto token renewal)")
